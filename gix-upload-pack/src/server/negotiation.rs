...
impl<'a> NegotiationEngine<'a> {
    ...
    fn parse_want_line(&self, line: &[u8], state: &mut NegotiationState) -> Result<gix_hash::ObjectId> {
    ...
    /// Parse shallow line
    fn parse_shallow_line(&self, line: &[u8], state: &mut NegotiationState) -> Result<gix_hash::ObjectId> {
